...
messageRoutes.post("/messages/read/:messageId", isAuth, MessageController.read);
messageRoutes.post("/messages/read/all/:ticketId", isAuth, MessageController.readAll)
